<!-- Form -->
<form action="{{ route('forms.store') }}" method="post" enctype="multipart/form-data" class="search-results__callback-form">
    @csrf
    ...
    <div class="search-results__callback-form__descr">
        {{ __( 'Пожалуйста, сообщите нам об этом и менеджер VUSO обязательно Вам поможет!' ) }}
    </div>
    <!-- excerpt -->
