...
<div class="card-banner news__banner">
    ...
    <picture class="card-banner__bg">
        <source
                srcset="{{ asset('assets/app/img/temp/cta-slide-desktop.jpg') }}"
                media="(min-width: 768px)"
        >
        <img
                src="{{ asset('assets/app/img/temp/cta-slide-mobile.jpg') }}"
                alt="{{ __( 'Оформляйте страховку c выгодой до 4000 грн.' ) }}"
                title="{{ __( 'Оформляйте страховку c выгодой до 4000 грн.' ) }}"
        >
    </picture>
    <!-- end picture -->
    ...
    <div class="card-banner__content">
        ...
        <h2 class="card-banner__title">
            {{ __( 'Оформляйте страховку c выгодой до 4000 грн.' ) }}
        </h2>
        <!-- end title -->

        <!-- excerpt -->
        <div class="card-banner__descr">
            {{ __( 'Оставьте онлайн заявку и служба заботы о клиентах все сделает за Вас: оформит и отправит договор' ) }}
        </div>
        <!-- end excerpt -->

        <!-- btn -->
        <button class="btn yellow card-banner__btn">
            <span>
                {{ __( 'Перейти к заявке' ) }}
            </span>
