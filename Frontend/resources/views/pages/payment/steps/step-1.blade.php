<!-- Step > 1 -->
<div class="online-payment__step online-payment__step--intial active">
    ...
    <div class="online-payment__group">
        ...
        <div class="online-payment__group-title">
            {{ __( 'Пожалуйста, введите номер договора' ) }}
        </div>
        <!-- end title -->
        ...
        <div class="online-payment__group-content">
            ...
            <!-- form -->
            <form action="{{ route('payment.check.contract') }}" method="post" class="paymentCheckContract">
                @csrf
