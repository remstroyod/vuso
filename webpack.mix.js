...
//Это временно решение, только для Backend
//Как раздеть фронт и бэк https://github.com/laravel-mix/laravel-mix/issues/1452
...
mix.js('./Backend/resources/js/app.js', './Backend/public/js')
    .sass('./Backend/resources/sass/app.scss', './Backend/public/css')
    .sourceMaps(true, 'source-map')
    // .webpackConfig({ devtool: 'source-map' })
    .browserSync({
        proxy: 'http://admin.vuso.loc',
        port: 3000,
        ghostMode: false,
        notify: false
    });
