...
class CreatePaymentDeliveryCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payment_delivery_categories', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('parent_id')->references('id')->on('payment_delivery_categories')
                ->onDelete('set null');
    ...
    {
        Schema::dropIfExists('payment_delivery_categories');
    }
}
