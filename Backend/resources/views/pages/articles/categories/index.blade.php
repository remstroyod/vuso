                ...
                <div class="card-body">
                    ...
                    <div class="card-body-headpanel">
                        ...
                        @permission('articles_create')
                            <a href="{{ route('articles.categories.create') }}" type="button" class="btn btn-primary">
                                {{ __( 'Создать запись' ) }}
                            </a>
                        @endpermission
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <form
                                                        action="{{ route('articles.categories.destroy', $item) }}"
                                                        method="post"
                                                ...
                                                <a href="{{ route('articles.categories.edit', $item) }}" class="btn btn-primary btn-xs">
                                                    {{ __( 'Изменить' ) }}
                                                </a>
                                                @endpermission
