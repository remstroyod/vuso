                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body-headpanel">
                            ...
                            @permission('pages_create')
                                <a href="{{ route('about.awards.create') }}" type="button" class="btn btn-primary">
                                    {{ __( 'Создать запись' ) }}
                                </a>
                            @endpermission
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($items as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->published_at && $item->date)
                                                    {{ $item->date->format('Y') }}
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <div class="d-flex">
                                                   ...
                                                   @permission('pages_destroy')
                                                        <form
                                                                action="{{ route('about.awards.destroy', $item) }}"
                                                                method="post"
                                                    ...
                                                    @permission('pages_update')
                                                        <a href="{{ route('about.awards.edit', $item) }}" class="btn btn-primary btn-xs">
                                                            {{ __( 'Изменить' ) }}
                                                        </a>
                                                    @endpermission
