...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 grid-margin ">
            ...
            @includeWhen($model, 'pages.about.tabs', ['page' => $model])
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body-headpanel">
                            ...
                            @permission('pages_create')
                                <a href="{{ route('about.history.create') }}" type="button" class="btn btn-primary">
                                    {{ __( 'Создать запись' ) }}
                                </a>
                            @endpermission
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <form
                                                            action="{{ route('about.history.destroy', $item) }}"
                                                            method="post"
                                                    ...
                                                    <a href="{{ route('about.history.edit', $item) }}" class="btn btn-primary btn-xs">
                                                        {{ __( 'Изменить' ) }}
                                                    </a>
                                                    @endpermission
