                ...
                <div class="card-body">
                    ...
                    <div class="card-body-headpanel">
                        ...
                        @permission('pages_create')
                            <a href="{{ route('partners.list.create') }}" type="button" class="btn btn-primary">
                                {{ __( 'Создать запись' ) }}
                            </a>
                        @endpermission
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <form
                                                        action="{{ route('partners.list.destroy', $item) }}"
                                                        method="post"
                                                ...
                                                <a href="{{ route('partners.list.edit', $item) }}" class="btn btn-primary btn-xs">
                                                    {{ __( 'Изменить' ) }}
                                                </a>
                                                @endpermission
